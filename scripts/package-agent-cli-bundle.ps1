...
$readmeLines = @(
    ...
    '  templates/migration-kit/scripts/validate-handoff.ps1 / validate-handoff.sh',
    '  templates/migration-kit/scripts/update-autonomy-state.ps1 / update-autonomy-state.sh',
