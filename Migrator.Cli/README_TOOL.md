...
- `explain-todo`, `smoke-plan`, `runtime-classify`, `migration-board`, `report-serve` — prioritize follow-up work from migration artifacts/runtime logs, classify runtime root causes, score readiness, and export triage decisions.
