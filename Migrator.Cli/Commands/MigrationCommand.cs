...
Migration planning and wave run commands:
  ...
  # after measured NO_PROGRESS for the same explicit helper/POM root:
  selenium-pw-migrator migration record-wave-decision --out migration/runs/wave-001 --decision SCAFFOLD_CURRENT_ROOT --pattern "<helper-root-pattern>"
