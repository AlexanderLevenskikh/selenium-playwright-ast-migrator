...
internal static class CliCommandCatalog
{
    ...
    static readonly CliCommandInfo[] Commands =
    {
        ...
        StableCommand("migration", "migration", false, false,
            ...
            "Direct command family: `selenium-pw-migrator migration inventory|cluster|plan|plan show`. The wavefront planner is read-only: it scans Selenium tests, builds clusters, writes waves.json/plan.md, and points agents to memory explain/doctor before any bounded wave work.",
