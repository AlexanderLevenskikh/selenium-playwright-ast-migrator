...
internal static class CliCommandCatalog
{
    ...
    static readonly CliCommandInfo[] Commands =
    {
        ...
        StableCommand("memory", "memory", false, false,
            ...
            "Direct command family: `selenium-pw-migrator memory init|add|explain|doctor|summarize`. Stores inspectable JSON/JSONL under migration/state/memory so later bounded actions, Reviewer, Watchdog, and Final Gate can reuse project-local decisions without relying on chat memory.",
