...
internal static class ConfigSchemaCommand
{
        ...
        return """
    {
      ...
      "properties": {
        ...
        "RecognizerAliases": { "type": "object", "additionalProperties": true },
        "GenericResultMethods": { "type": "array", "items": { "type": "string" } },
        "WaitPolicies": { "type": "array", "items": { "type": "object", "additionalProperties": true } },
        "SuppressedMethods": { "type": "array", "items": { "type": "string" } },
        "SuppressedMethodPatterns": { "type": "array", "items": { "type": "string" } }
      }
    }
    """;
    }
