...
record MigrationIterationSnapshot(string WorkspaceRoot, ProjectMemoryDashboardSnapshot Memory, WavefrontDashboardSnapshot Wavefront, ConfigMergeDashboardSnapshot ConfigMerge, string[] NextCommands, string[] EvidenceFiles);
...
record WavefrontDashboardSnapshot(bool PlanExists, string PlanPath, int Waves, int CompletedWaveRuns, string[] NextWaveIds, string MemoryRecallPath);
