...
public class FluentAssertionsRecognizer : IInvocationRecognizer
{
    ...
    public FluentAssertionsRecognizer()
        : this(RecognizerOptions.Default.FluentAssertionMethods)
    {
    }

    public FluentAssertionsRecognizer(IEnumerable<string> fluentMethods)
    {
        _fluentMethods = new HashSet<string>(
            fluentMethods
