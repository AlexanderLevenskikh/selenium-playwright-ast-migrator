...
namespace Migrator.PublicDemo.Selenium.Xunit;

public class LoginSmokeFacts
{
    private readonly DemoShopApp app;

    public LoginSmokeFacts()
    {
        app = Navigation.OpenDemoShop();
        app.Loader.ValidateLoading();
    }

    [Fact(DisplayName = "Login, filter, cart, and checkout")]
