...
| `explain-todo` / `smoke-plan` / `runtime-classify` / `migration-board` / `report-serve` | Experimental | Приоритизация fixes по artifacts/logs, runtime root causes, readiness score, dashboard по run artifacts и экспорт triage decisions. |
