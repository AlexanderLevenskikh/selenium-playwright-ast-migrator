...
| `/supervised-task <bounded запрос> continuous` | Выполнить bounded-запрос и продолжать через последующие разрешённые continuation-state. |
