...
install -> doctor install -> playground/start -> pilot/standard run -> gates -> current-ticket -> mapping research memory -> feedback-bundle/v1
```

Checklist:

- `README.md` and `README.ru.md` link to `docs/public-preview-flow.md` / `.ru.md`.
- `docs/public-preview-flow.md` mentions the ordinary full-run flow, real project verification, artifact hygiene, bounded repair, and feedback bundle handoff.
- `docs/standard-migration-flow.md` is the operational reference for blocked runs and follow-up loops.
