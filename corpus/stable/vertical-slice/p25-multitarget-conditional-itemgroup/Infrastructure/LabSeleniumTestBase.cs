...
public abstract class LabSeleniumTestBase
{
    ...
    public void StartBrowser()
    {
        ...
        Assert.That(Migrator.Lab.Corpus.P25.Shared.SharedContract.Expected, Is.EqualTo("ok"));
    }
...
public partial class MultiTargetTests : LabSeleniumTestBase
{
    protected override string RelativePath => "/smoke";
}
