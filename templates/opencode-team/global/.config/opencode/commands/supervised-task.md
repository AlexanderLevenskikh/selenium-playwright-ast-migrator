...
3. In wavefront mode, after the current wave is final, scope-clean, quality-budget-clean, and has no active repair ticket, select/materialize the next pending planned wave and continue. Do not skip mapping research, remediation, review, or gates to reach the next wave.
