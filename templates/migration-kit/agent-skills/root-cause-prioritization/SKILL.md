...
3. Choose one bounded root pattern with the highest affected-test count and reusable value.
4. Require a before/after delta after regeneration of the same wave.
