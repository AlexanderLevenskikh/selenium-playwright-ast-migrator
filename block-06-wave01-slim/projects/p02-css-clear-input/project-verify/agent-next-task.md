...
- Files/tests/actions: `1` / `1` / `6`
- TODO/unmapped/unsupported: `2` / `0` / `0`
...
| 2 | `MANUAL_REVIEW` | MANUAL_REVIEW: unclassified helper/raw family | 1 | Inspect representative source snippets and classify this family before changing mappings or suppressions. |
