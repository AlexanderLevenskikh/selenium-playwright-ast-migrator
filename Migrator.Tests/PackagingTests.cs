...
public class PackagingTests
{
    ...
    public void PackagingScripts_ArePresent()
    {
        ...
        Assert.True(File.Exists(FindRepositoryFile("scripts/install-local-tool.sh")));
        ...
        Assert.True(File.Exists(FindRepositoryFile("scripts/verify-agent-cli-bundle.sh")));
        Assert.True(File.Exists(FindRepositoryFile("scripts/publish-standalone.ps1")));
        Assert.True(File.Exists(FindRepositoryFile("scripts/publish-standalone.sh")));
        ...
        Assert.True(File.Exists(FindRepositoryFile("scripts/package-agent-cli-bundle.ps1")));
        Assert.True(File.Exists(FindRepositoryFile("scripts/package-agent-cli-bundle.sh")));
        Assert.True(File.Exists(FindRepositoryFile("scripts/verify-standalone-package.ps1")));
        Assert.True(File.Exists(FindRepositoryFile("scripts/verify-standalone-package.sh")));
        Assert.True(File.Exists(FindRepositoryFile("scripts/verify-release-artifacts.ps1")));
        Assert.True(File.Exists(FindRepositoryFile("scripts/verify-release-artifacts.sh")));
        ...
        Assert.True(File.Exists(FindRepositoryFile("scripts/smoke-npm-wrapper.ps1")));
        Assert.True(File.Exists(FindRepositoryFile("scripts/smoke-npm-wrapper.sh")));
