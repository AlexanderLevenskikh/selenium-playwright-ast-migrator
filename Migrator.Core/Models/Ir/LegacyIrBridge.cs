...
public static class LegacyIrBridge
{
    ...
    static TestStatementIr ToStatement(TestAction action, string filePath, List<IrDiagnostic> diagnostics)
    {
        ...
        return action switch
        {
            ...
            MethodInvocationAction method => new MethodInvocationStatementIr(method.ReceiverExpression, method.MethodName, method.ArgumentTexts.Select(ToValue).ToArray(), method.FullSourceText, method.ResultVariable, span, method.IsAwaited),
    ...
    static TestAction ToLegacyAction(TestStatementIr statement)
    {
        ...
        return statement switch
        {
            ...
            MethodInvocationStatementIr method => new MethodInvocationAction(line, method.ReceiverExpression, method.MethodName, method.SourceText, method.Arguments.Select(ToLegacyValue).ToArray(), Array.Empty<string>(), method.ResultVariable, isAwaited: method.IsAwaited),
