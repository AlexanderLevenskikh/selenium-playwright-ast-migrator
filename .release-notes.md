...
### Wave quality boundary

- Added outcome-driven wave measurement and a bounded migration wave manager.
- Added hard next-wave acceptance receipts, representative calibration, payoff-ranked root remediation, honest budget-exhausted draft stops, current-input validation binding, measured before/after remediation receipts, and complete-wave-chain revalidation.
- Preserved semantic/fallback/TODO/unmapped metrics as observability without letting editable reports authorize acceptance.
